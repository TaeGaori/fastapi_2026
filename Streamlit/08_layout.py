# =============================================================================
# ~/bigdata2026/fastapi/Steamlit/08_layout.py
#
...
st.header('포켓몬')
st.image(img1, width=400, caption='메타몽, 피카츄, 이상해씨, 꼬북이, 잠만보')
...
with col1:
    st.header('포켓몬')
    st.image(img1, width=300, caption='메타몽, 피카츄, 이상해씨, 꼬북이, 잠만보')
with col2:
    st.header('피카츄')
...
df = pd.read_csv('../cafe/input/menu.csv')
