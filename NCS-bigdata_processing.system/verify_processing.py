# ================================================
# NCS-bigdata_porcessing_system/verify_processing.py
...
CHECKS = [
    ...
    (subway_engine, 'traffic_subway_event_alerts'),     # 이벤트 처리 결과 : 지하철 혼잡 알람
    (bus_engine, 'traffic_bus_area_summary'),           # 배치 처리 결과 : 지역별 버스 집계
    (bus_engine, 'traffic_bus_event_alerts'),           # 이벤트 처리 결과 : 버스 이상 알람
]
