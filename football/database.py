...
#       engine / SessionLocal / Base 세 가지를 만들어 준다.
# ======================
import os
...
# ---------------------------------------------
# DeclarativeBase : SQLAlcemy 2.0에서 새로 생긴 "모델의 공통 조상 클래스"를 마드는 방식
...
#                 매번 새로 연결을 맺지 않고, 미리 만들어둔 열결 여러 개를 재사용한다.
# 
# pool_pre_ping=True
...
class Base(DeclarativeBase):
    """모든 ORM 모델들이 상속하는 SQLlchempy 2.0의 선언적 기준 클래스"""
    pass 
